      ...
      <div className="mx-auto h-full sm:w-max  mb-8">
        <div className="m-auto shadow-xl">
          <div className="mt-12 rounded-3xl border bg-white -mx-6 sm:-mx-10 p-8 sm:p-10">
            ...
            <div className="mt-12 flex flex-wrap sm:grid gap-6 grid-cols-2">
              <button className="w-full h-11 rounded-full border border-gray-300 bg-white px-6 transition hover:bg-gray-50">
                <div className="w-max mx-auto flex items-center justify-center space-x-4">
                  <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/53/Google_%22G%22_Logo.svg/2008px-Google_%22G%22_Logo.svg.png" className="w-5" alt="" />
            ...
            <form onSubmit={handleSLogin} className="mt-10 space-y-8">
              <div>
              ...
              <div>
                <button
                  className="w-full rounded-full bg-sky-500 h-11 flex items-center justify-center px-6 py-3 transition hover:bg-sky-600"
                >
                  <span className="text-base font-semibold text-white">Login</span>
                </button>
                <button href="#" type="reset" className="-ml-3 w-max p-3">
                 <Link to='/signup'> <span className="text-sm tracking-wide text-sky-600">Create new account</span></Link>
                </button>
              </div>
            </form>
          </div>
